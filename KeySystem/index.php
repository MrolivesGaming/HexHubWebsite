...
<section class="section page-title">
	<div class="container">
        ...
        <center>
				<h1>KEY SYSTEM</h1>
        <h4 style="color: rgb(68, 68, 68);">CHECKPOINT 1</h4>
      </center>
				<!-- Page Description -->
				<p></p>
			</div>
...
<section class="ass cum">
  <div>
    <div class="col-12 text-center">
      <h4 style="color: rgb(97, 97, 97);">TO CONTINUE, PLEASE TICK THE BOX BELOW!</h4>
      
      <form id="frmContact" action="https://workink.biz/2jM/HexHubCheckPoint1" method="POST" novalidate="novalidate">
   <div style="display: inline-block;" class="g-recaptcha" data-sitekey="6Le7bLonAAAAAM5sP4Em-5AKqpv5XcwhgwXpTj1t"></div>
   <div style="text-align: center;">
   <input class="btn btn-sm btn-primary me-1" type="Submit" name="Submit">
      </div>
  </div>
  </form>
</section>
